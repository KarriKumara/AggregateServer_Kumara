 ...
 */
public class ASServerStatusListener implements ServerStatusListener {
	@Override
	public void onShutdown(UaClient uaClient, long secondsTillShutdown,
		...
		AggregateServerConsoleClient.printf(
	...
	public void onStateChange(UaClient uaClient, ServerState oldState,
		...
		AggregateServerConsoleClient.printf("ServerState changed from %s to %s\n",
				oldState, newState);
		if (newState.equals(ServerState.Unknown))
			AggregateServerConsoleClient.println("ServerStatusError: "
