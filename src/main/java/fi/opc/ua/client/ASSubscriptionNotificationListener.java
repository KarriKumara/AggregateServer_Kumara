 ...
 */
public class ASSubscriptionNotificationListener implements
	...
	public void onBufferOverflow(Subscription subscription,
		...
		AggregateServerConsoleClient.println("*** SUBCRIPTION BUFFER OVERFLOW ***");
	}
	...
	public void onError(Subscription subscription, Object notification,
		...
		// an EventList
		AggregateServerConsoleClient.printException(exception);
	}
	...
	public long onMissingData(UnsignedInteger lastSequenceNumber,
		...
		// failing Republish
		AggregateServerConsoleClient.println("Data missed: lastSequenceNumber="
