 ...
 *
 * @see {@link ASNodeManager#createMyEventType}
 */
@TypeDefinitionId(nsu = ASNodeManager.NAMESPACE, i = ASEventType.MY_EVENT_ID)
public class ASEventType extends BaseEventTypeNode {
	 ...
	 * visibility.
	 */
	protected ASEventType(NodeManagerUaNode nodeManager, NodeId nodeId,
